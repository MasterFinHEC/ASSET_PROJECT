...
%% Testing the Auto-correlations of the data
...
% 1. Computing the Volatility Parity Model
VolParityBaltasWayComputations;

% 2. Computing the Volatility Parity Long Only Model
...
% Computing the returns and weights of the strategy
